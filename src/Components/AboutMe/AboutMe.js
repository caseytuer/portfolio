...
const aboutMe1 = "I have always been fascinated with technology and aspired to one day pursue a career in software development. After years of learning to code on my own while working full time in the service industry, I made the decision to attended App Academy's 1500 hr full stack software engineering program. Here I was formally trained in software development and introduced to the most in-demand programming tools to date." 
